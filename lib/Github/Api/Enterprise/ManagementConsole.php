...
class ManagementConsole extends AbstractApi
{
     ...
     *
     * @param string $password the Management Console password
     *
     * @return array array of configuration status information
     */
    public function configcheck($password)
    {
        return $this->getWithPassword('/setup/api/configcheck', $password);
    }
    ...
    {
        return $this->getWithPassword('/setup/api/settings', $password);
    }
    ...
    {
        return $this->getWithPassword('/setup/api/maintenance', $password);
    }
    ...
    {
        return $this->getWithPassword('/setup/api/settings/authorized-keys', $password);
    }
     ...
     */
    protected function getWithPassword($uri, $password)
    {
