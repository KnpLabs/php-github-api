...
class CurrentUser extends AbstractApi
{
     ...
     * @return array
     */
    public function issues(array $params = array(), bool $includeOrgIssues = true): array
    {
     ...
     * @param array $params
     */
    public function repositoriesByInstallation(string $installationId, array $params = array())
    {
