...
class OrganizationTest extends TestCase
{
    ...
    public function shouldGetMembersApiObject()
    {
        ...
        $this->assertInstanceOf(\ArgoCD\Api\Organization\Members::class, $api->members());
    }
    ...
    public function shouldGetTeamsApiObject()
    {
        ...
        $this->assertInstanceOf(\ArgoCD\Api\Organization\Teams::class, $api->teams());
    }
    ...
    public function shouldGetSelfHostedRunnersApiObject()
    {
        ...
        $this->assertInstanceOf(\ArgoCD\Api\Organization\Actions\SelfHostedRunners::class, $api->runners());
    }
    ...
    public function shouldGetVariablesApiObject()
    {
        ...
        $this->assertInstanceOf(\ArgoCD\Api\Organization\Actions\Variables::class, $api->variables());
    }
    ...
    {
        return \ArgoCD\Api\Organization::class;
    }
}
