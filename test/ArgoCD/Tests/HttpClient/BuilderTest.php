...
namespace ArgoCD\Tests\HttpClient;
...
class BuilderTest extends \PHPUnit\Framework\TestCase
{
    ...
    {
        $builder = $this->getMockBuilder(\ArgoCD\HttpClient\Builder::class)
    ...
    public function shouldAddHeaders()
    {
        ...
        $client = $this->getMockBuilder(\ArgoCD\HttpClient\Builder::class)
            ->setMethods(['addPlugin', 'removePlugin'])
            ->getMock();
